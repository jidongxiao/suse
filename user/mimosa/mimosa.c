...
int doAll(unsigned char *ciphertext, key_rsa *cipherKey){
  ...
  //unsigned char decrypted_RSA_D[sizeof(RSA_KEY_NO_LABEL)];
  //unsigned char decrypted_RSA_P[sizeof(RSA_KEY_NO_LABEL)];
  //unsigned char decrypted_RSA_Q[sizeof(RSA_KEY_NO_LABEL)];
  //unsigned char decrypted_RSA_DP[sizeof(RSA_KEY_NO_LABEL)];
  //unsigned char decrypted_RSA_DQ[sizeof(RSA_KEY_NO_LABEL)];
  //unsigned char decrypted_RSA_QP[sizeof(RSA_KEY_NO_LABEL)];
...
//    printf("decrypt D is : %s\n",decrypted_RSA_D );
   ...
   printf("sizeof RSA P is %d, decrypted P is : %s\n",sizeof(RSA_P), decrypted_RSA_P );
   ...
   printf("sizeof RSA Q is %d, decrypted Q is : %s\n",sizeof(RSA_Q), decrypted_RSA_Q );
   ...
   printf("sizeof RSA DP is %d, decrypted DP is : %s\n",sizeof(RSA_DP), decrypted_RSA_DP );
   ...
   printf("sizeof RSA DQ is %d, decrypted DQ is : %s\n",sizeof(RSA_DQ), decrypted_RSA_DQ );
