...
/*
 * What is it? why 233? Number of system call?
 * or some sort of magic number? Is it random? I can choose anything Instead of 233?
 * */
#define DUNE_MINOR       233

/*
 * The ioctl command numbers should be unique across the system
 * _IO, _IOW, _IOR are helper macros to create a unique ioctl identifier
 * */
...
/*
 * From where they get all this address?
 * Is this something programmer defined constant??
 * */
