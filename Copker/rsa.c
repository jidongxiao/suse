...
cleanup:
    ...
    mpi_free1( &P1 ); mpi_free1( &Q1 ); mpi_free1( &H ); mpi_free1( &G );
...
cleanup:
    mpi_free1( &PQ ); mpi_free1( &DE ); mpi_free1( &P1 ); mpi_free1( &Q1 );
    mpi_free1( &H  ); mpi_free1( &I  ); mpi_free1( &G  ); mpi_free1( &G2 );
    mpi_free1( &L1 ); mpi_free1( &L2 ); mpi_free1( &DP ); mpi_free1( &DQ );
    mpi_free1( &QP );
...
cleanup:
    ...
    mpi_free1( &T ); mpi_free1( &T1 ); mpi_free1( &T2 );
...
{
    mpi_free1( &ctx->RQ ); mpi_free1( &ctx->RP ); mpi_free1( &ctx->RN );
    mpi_free1( &ctx->QP ); mpi_free1( &ctx->DQ ); mpi_free1( &ctx->DP );
    mpi_free1( &ctx->Q  ); mpi_free1( &ctx->P  ); mpi_free1( &ctx->D );
    mpi_free1( &ctx->E  ); mpi_free1( &ctx->N  );
}
